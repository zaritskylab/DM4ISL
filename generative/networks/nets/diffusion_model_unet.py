...
class DiffusionModelUNet(nn.Module):
    ...
    def forward(
        ...
        """
        # 1. time
        t_emb = get_timestep_embedding(timesteps, self.block_out_channels[0]) ## positional emb
        ...
        if self.num_class_embeds is not None: ## DiffustionModel -- make sure num_class_embeds is correct 
        ...
        h = self.conv_in(x)  # [16, 128, 64, 64, 16]
